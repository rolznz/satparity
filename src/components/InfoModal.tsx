    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
        ...
        <div className="text-gray-600">
          <p className="mb-4">
            This site tracks Bitcoin's purchasing power across different
            currencies and predicts when each currency will reach "sat parity" -
            the point where 1 satoshi equals or exceeds 1 unit of that currency.
          </p>
          <p className="mb-4">
            This website was 99% made by PPQ.ai using the Cline VSCode plugin
            with Claude 3.5 Sonnet, costing approximately 13,175 sats or $10 as
            of November 8, 2024 and 2 hours of human time.
          </p>
          <div className="mt-4">
            <a
